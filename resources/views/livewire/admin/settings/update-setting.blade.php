            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form wire:submit.prevent.default="updateSetting">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="siteEmail">Site Emial</label>
                                    <input wire:model.defer="state.site_email" type="text" class="form-control" id="siteEmail"
                                ...
                                <div class="form-group">
                                    ...
                                    <input wire:model.defer="state.footer_text" type="text" class="form-control" id="footerText"
                            ...
                            <div class="card-footer">
                                <button type="submit" id="submit" class="btn btn-primary"><i class="fa fa-save mr-1"></i>Save Changes</button>
                            </div>
                        </form>
                    </div>
                    <!-- /.card -->
