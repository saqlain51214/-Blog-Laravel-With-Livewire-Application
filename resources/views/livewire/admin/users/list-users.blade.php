                        ...
                        <table class="table table-hover">
                            ...
                            <tbody wire:loading.class="text-muted">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img src="{{$user->avatar_url}}" style="width: 50px" alt="Profile" class="img img-circle mr-1">
                                        {{$user->name}}
                                    </td>
                                    <td>{{$user->email}}</td>
                                    <td>{{$user->created_at->toFormattedDate()}}</td>
                                    <td>
                                        <select wire:change="changeRole({{$user}}, $event.target.value)" class="form-control" name="role" id="role">
                                ...
                                <tr class="text-center">
                                    ...
                                    <img style="width:60px;height:60px;" src="{{asset('images/search.svg')}}" alt="No result found">
